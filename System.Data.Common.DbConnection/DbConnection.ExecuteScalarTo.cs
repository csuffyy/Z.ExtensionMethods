...
{
    /// <summary>
    ///     A DbConnection extension method that executes the scalar to operation.
    /// </summary>
    ...
    /// <returns>.</returns>
    public static T ExecuteScalarTo<T>(this DbConnection @this, string cmdText, List<KeyValuePair<string, object>> parameters = null)
    {
